...
from db.db_manager import create_session, join_session, get_role, delete_session, get_sessions, get_master_session, get_session_by_user, leave_session, user_has_session, get_users_in_session

async def process_create_command(message: Message):
    user_id = message.from_user.id
    if await user_has_session(user_id):
